...
class PathGetter(object):
    ...
    def get_source_paths(self, filepath):
        ...
        self.num_layers = 0
        if arcpy.mapping.ListLayers(mxd):
            for lyr in arcpy.mapping.ListLayers(mxd):
                self.num_layers += 1
...
if __name__ == '__main__':
    mxd = r'Y:\0110_BES_Copy\Source_Figures\004_CERCLA\Thiessen_Mapping\Surface\RM11E\1943_Air_Photo_Thiessen_Surface_Total_PCB_Aroclors_RM10_5to12_5.mxd'
    getter = PathGetter(r'Y:\0110_BES_Copy\Source_Figures\004_CERCLA\Thiessen_Mapping\Surface\RM11E')
    result = getter.get_source_paths(mxd)
    print result
